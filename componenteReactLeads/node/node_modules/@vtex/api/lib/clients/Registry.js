...
class Registry extends HttpClient_1.InfraClient {
    constructor(context, options) {
        super('apps@0.x', Object.assign({}, context, { workspace: constants_1.DEFAULT_WORKSPACE }), options);
        this.publishApp = (files, tag, { zlib } = {}) => {
            return this.publish(routes.Publish, files, tag, { zlib });
        };
        this.publishAppRc = (files, tag, { zlib } = {}) => {
            return this.publish(routes.PublishRc, files, tag, { zlib });
        };
        this.publish = async (route, files, tag, { zlib } = {}) => {
